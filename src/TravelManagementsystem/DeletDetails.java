...
public class DeletDetails extends JFrame implements ActionListener
{
    ...
    public void actionPerformed(ActionEvent ae)
    {
        try {
            Conn c = new Conn();
            c.s.executeUpdate("delete from account where username = '"+uname+"'");
            c.s.executeUpdate("delete from customer where username = '"+uname+"'");
            c.s.executeUpdate("delete from bookpackage where username = '"+uname+"'");
            c.s.executeUpdate("delete from bookhotel2 where username = '"+uname+"'");
